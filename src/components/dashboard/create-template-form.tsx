...
export default function CreateTemplateForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let frameUrl = isEditMode && initialData ? initialData.frame_image_url : ''
      ...
      if (isEditMode) {
        ...
        const { error: insertError } = await supabase
          .from('event_badge_templates')
          .insert({ name, shape, event_id: eventId, user_id: userId, frame_image_url: frameUrl, is_public: false })
